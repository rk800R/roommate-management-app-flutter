...
class _ChoreBoardScreenState extends State<ChoreBoardScreen> {
  ...
  /// Set to `true` in the edit sheet when the user explicitly taps "Clear date"
  /// so [updateChore] knows to call [FieldValue.delete()] on `dueDate`.
  bool _editClearDueDate = false;
                  ...
                  children: [
                    ...
                    if (members.isNotEmpty)
                      DropdownButtonFormField<String>(
                        initialValue: _assignedTo.isEmpty
                            ? members.first.name
                            : _assignedTo,
                      ...
                      children: [
                        Expanded(
                          child: DropdownButtonFormField<String>(
                            ...
                            onChanged: (v) =>
                                setModalState(() => _category = v ?? 'General'),
                          ),
                        ),
                        ...
                        Expanded(
                          child: DropdownButtonFormField<String>(
                            ...
                            items: const [
                              DropdownMenuItem(
                                value: ChorePriority.normal,
                                child: Text('Normal'),
                              ),
                              DropdownMenuItem(
                                value: ChorePriority.urgent,
                                child: Text('Urgent'),
                              ),
                            ],
                            onChanged: (v) => setModalState(
                                  () => _priority = v ?? ChorePriority.normal,
                            ),
                          ),
                        ),
                      ],
                      ...
                      children: [
                        ...
                        IconButton(
                          ...
                          onPressed: () async {
                            ...
                            if (confirmed == true) {
                              // AuthWrapper reacts to authStateChanges() and
                              // navigates to LoginScreen automatically.
                  ...
                  Padding(
                    ...
                    child: Row(
                      children: [
                        _FilterChip(
                          label: 'Pending',
                          selected: _filter == ChoreFilter.pending,
                          onTap: () =>
                              setState(() => _filter = ChoreFilter.pending),
                        ),
                        const SizedBox(width: 8),
                        _FilterChip(
                          label: 'Completed',
                          selected: _filter == ChoreFilter.completed,
                          onTap: () =>
                              setState(() => _filter = ChoreFilter.completed),
                        ),
                        const SizedBox(width: 8),
                        _FilterChip(
                          label: 'All',
                          selected: _filter == ChoreFilter.all,
                          onTap: () =>
                              setState(() => _filter = ChoreFilter.all),
                        ),
                      ],
                    ),
                  ),
                        ...
                        if (chores.isEmpty) {
                          return Center(
                            child: Padding(
                              ...
                              child: Text(
                                _filter == ChoreFilter.all
                                    ? 'No chores yet. Tap + to add one.'
                                    : 'No ${_filter == ChoreFilter.pending ? "pending" : "completed"} chores.',
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return ChoreBoardTile(
                              chore: chore,
                              onToggle: () => _dashboard.setChoreCompleted(
                                chore.id,
                                !chore.completed,
                              ),
                              onDelete: () => _dashboard.deleteChore(chore.id),
                              onEdit: () =>
                                  _showEditChoreSheet(chore, members: _members),
                            );
                          },
                        );
                      },
  ...
  void _showEditChoreSheet(Chore chore, {required List<Member> members}) {
    ...
    _editClearDueDate = false; // reset for each edit session
                        ...
                        onPressed: _isSaving
                          ...
                          try {
                            ...
                            await _dashboard.updateChore(
                              ...
                              assignedTo: _assignedTo.isEmpty
                                  ? 'Unassigned'
                                  : _assignedTo,
                              category: _category,
                              priority: _priority,
                              points: pts,
                              dueDate: _dueDate,
                              clearDueDate: _editClearDueDate,
                            );
                            if (isMounted) {
                              _resetForm();
                              nav.pop();
...
class ChoreBoardTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isUrgent =
        chore.priority.toLowerCase() == ChorePriority.urgent.toLowerCase();
            ...
            children: [
              GestureDetector(
                ...
                child: AnimatedContainer(
                  ...
                  width: 28,
                  height: 28,
                  decoration: AppDecorations.toggleCircle(
              ...
              Container(
                ...
                decoration: AppDecorations.tileIcon(
                  color: color,
                  active: !chore.completed,
                ),
                child: Icon(
                  Icons.cleaning_services_rounded,
                  color: chore.completed ? AppColors.textMuted : color,
                  size: 20,
                ),
              ),
              AppPadding.space12,
                  ...
                  children: [
                    Text(
                      ...
                      style: chore.completed
                          ? AppTextStylesExtended.choreTitleCompleted
                          : AppTextStylesExtended.choreTitle,
                    ),
                    ...
                    Text(
                      ...
                      overflow: TextOverflow.ellipsis,
                      style: chore.completed
                          ? AppTextStylesExtended.choreSubtitleCompleted
                          : AppTextStylesExtended.choreSubtitle,
                    ),
                  ],
                ),
              ),
                ...
                children: [
                  ...
                  if (isUrgent && !chore.completed) ...[
                    ...
                    Container(
                      ...
                      child: Text(
                        'Urgent',
                        style: AppTextStylesExtended.urgentBadge,
                      ),
                    ),
                  ],
                  AppPadding.space4,
                  Text(
                    ...
                    style: chore.completed
                        ? AppTextStylesExtended.choreDateCompleted
                        : AppTextStylesExtended.choreDate,
                  ),
                ],
              ),
            ],
